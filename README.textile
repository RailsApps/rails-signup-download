...
Rails 4.1 example application that allows a visitor to sign up for an account and download a PDF file. The application requires:
...
This application extends the "rails-devise-pundit":https://github.com/RailsApps/rails-devise-pundit example application, showing how to provide a PDF file download when a visitor registers for an account.
...
The application can be combined with the "rails-mailinglist-signup":https://github.com/RailsApps/rails-mailinglist-signup application to add the visitor's email address to a mailing list.

This application is a foundation for the "rails-stripe-checkout":https://github.com/RailsApps/rails-stripe-checkout application that shows how to implement credit card payment for a file download.
